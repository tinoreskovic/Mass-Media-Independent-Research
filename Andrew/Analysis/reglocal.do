...
import excel "DataStata.xlsx", sheet("Sheet2") firstrow clear case(lower)
set more off
...
esttab using "Output/reglocal.rtf", replace compress ci r2
esttab, se r2
...
graph export "Output/fals_local.png", replace
