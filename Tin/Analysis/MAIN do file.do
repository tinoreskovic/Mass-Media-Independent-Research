...
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games
rvfplot
...
reg logvalue logmentions st_primary i.POSI i.transfer_year transfer_age games
// other iterations of (I)  (INCLUDE IN APPENDIX)
reg logvalue logmentions primary i.POSI i.transfer_year i.transfer_age games
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age agesq games
//without media best
reg logvalue primary i.POSI i.transfer_year transfer_age games
rvfplot
...
//team team 5 revenuewise
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games if team
reg logvalue logmentions team i.team#c.logmentions primary i.POSI i.transfer_year transfer_age games
rvfplot
...
//without media best for team 5
reg logvalue primary i.POSI i.transfer_year transfer_age games if team
rvfplot
predict teamnomediaestimate, xb
predict teamnomediaresiduals, r
twoway (scatter teamnomediaestimate logvalue) (lfit teamnomediaestimate logvalue)
//>5
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games if valuegroup5
rvfplot
...
//>10
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games if valuegroup10
rvfplot
...
//>15
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games if valuegroup15
rvfplot
...
//>20
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age games if valuegroup20
rvfplot
...
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age  if valuegroupfirst10 
rvfplot
...
//smaller than 20
reg logvalue logmentions primary i.POSI i.transfer_year transfer_age  if valuegroupfirst20 
rvfplot
...
// INTERACTIONS
reg logvalue logmentions primary c.primary#i.team i.POSI i.transfer_year transfer_age games
reg logvalue logmentions c.logmentions#i.team primary i.POSI i.transfer_year transfer_age games
reg logvalue logmentions c.logmentions#i.team primary c.primary#i.team i.POSI i.transfer_year transfer_age games
reg logvalue logmentions c.logmentions#i.team primary c.primary#i.team i.POSI i.transfer_year transfer_age c.transfer_age#i.team games c.games#i.team
reg logvalue logmentions c.logmentions#i.team primary c.primary#i.team i.POSI i.POSI#i.team i.transfer_year i.transfer_year#i.team transfer_age c.transfer_age#i.team games c.games#i.team i.team
