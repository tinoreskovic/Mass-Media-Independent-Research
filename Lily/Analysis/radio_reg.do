...
legend(order(1 "Broadcasting" 2 "No Broadcasting")) title("Same DMA Broadcasting Available to 1930 Population") saving("${output}scatter_population_access", replace)
restore
